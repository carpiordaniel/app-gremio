...
import { ICarrera } from "../../../domain/parametros/carrera/interface/carreraInterface";
export class CarreraRepository  implements ICarrera {
  
  async getAllCarrera(): Promise<GremioModel[] | undefined> {
    try {
      const response = await fetch(`${API_URL}/web/obtenerCatalogoParametro/CARRERA`, {
        method: 'GET',
        headers: {
